      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 p-8 text-center">
            ...
            <p className="text-white/80 mt-2">Administrative access only</p>
          </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-3 px-4 rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
              ...
              <div className="border-t border-gray-200 pt-6">
                <p className="text-sm text-gray-600 text-center">
                  Forgot admin credentials? Contact super administrator.
                </p>
