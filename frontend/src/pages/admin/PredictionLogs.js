...
const PredictionLogs = () => {
  ...
  if (!loading && filteredPredictions.length === 0 && predictions.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Prediction Logs</h1>
            <p className="text-gray-600 mt-2">Monitor and manage all job prediction requests</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600">Prediction logs will appear here once users start making job predictions.</p>
          </div>
        </div>
      </div>
    );
