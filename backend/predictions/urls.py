...
urlpatterns = [
    ...
    path('predict', views.PredictJobView.as_view()), # Fix for 404/405
    ...
    path('history/save', views.SavePredictionHistoryView.as_view()),
    ...
    path('model/status', views.MLModelStatusView.as_view()),
